...
// 
// // RVA
//#define oButtons_TypeInfo 50026664  //2F0D518 Buttons_TypeInfo
//#define oLineOfSightRadius 0x6D8870////public static bool LineOfSightRadius(Vector3 p0, Vector3 p1, int layerMask, float radius, BaseEntity ignoreEntity) { }
//#define oCanReload 0x5730E0  // public bool CanReload(BasePlayer owner) { }
#define oSphereCast 0x29665D0  //public static bool SphereCast(Ray ray, float radius, float maxDistance, int layerMask) { }
#define oGetWorldVelocity 0x5C14F0  //public Vector3 GetWorldVelocity() { }
#define oSetRayleigh 0xC51DF0 //public static void set_atmosphere_rayleigh(float value) { } just make this for all adress
#define oConsoleSystem_GetAll 15457504  // ConsoleSystem.Index$$get_All
#define oConvarGraphics 54893224 //ConVar_Graphics_c
//#define oConvarClient 49842536 // ConVar_Client_c
#define oConvarAdmin 54596872  //ConVar_Admin_c
#define oTerrainMeta_TypeInfo 54868224//TerrainMeta_TypeInfo
#define oPlayerEyes_TypeInfo 54648208//PlayerEyes_TypeInfo
#define oPlayerBelt_TypeInfo 54646584//PlayerBelt_TypeInfo
#define oSet_Sprinting 33396768//ModelState$$set_sprinting",
#define oBaseNetworkable_c 54642328 //BaseNetworkable_TypeInfo
#define oStringPool 0x9ECCD0 //public static uint Get(string str) { }  dump.cs public class StringPool // TypeDefIndex: 2826
#define oConsoleSystem_Index_c 55103368//ConsoleSystem.Index_TypeInfo


//REAL RUST
namespace offsets {
	constexpr auto Method$BaseEntity_ServerRPC_CreateBuilding___ = 54883720;// "Name": "Method$BaseEntity.ServerRPC<CreateBuilding>()
	constexpr auto Method$BaseEntity_ServerRPC_PlayerProjectileAttack___ = 54885264;// "Name": Method$BaseEntity.ServerRPC<PlayerProjectileAttack>()"
	constexpr auto Method$BaseEntity_ServerRPC_PlayerProjectileShoot___ = 54885920;// "Name": "Method$BaseEntity.ServerRPC<ProjectileShoot>()"
	// constexpr auto Method$BaseEntity_ServerRPC_PlayerProjectileUpdate___ = 49824088;// "Name": "Method$BaseEntity.ServerRPC<PlayerProjectileUpdate>()"
	//constexpr auto Method$Facepunch_Pool_GetList_TraceInfo_Address = 49766176;// "Name": "Method$Facepunch.Pool.GetList\u003CTraceInfo\u003E()"
	//constexpr auto Method$Facepunch_Pool_GetList_TraceInfo_MethodAddress = 17380752;// method address

	constexpr auto Method_BaseEntity_ServerRPC_string_bool_address = 54890984;// address "Name": "Method$BaseEntity.ServerRPC<string, bool>()",

	//constexpr auto Method$BaseEntity_ServerRPC_uint = 49849496;// "Address":,"Method$BaseEntity.ServerRPC\u003Cuint\u003E()" //both addresses
	//constexpr auto BaseEntity$$ServerRPC_uint_ = 16293648;// method address//
}
...
namespace O {
	...
	namespace BasePlayer {
		...
		constexpr auto maxProjectileID = 0x6f0;
		constexpr auto lastUpdateTime = 0x6f4;
		constexpr auto cachedThreatLevel = 0x6f8;
		constexpr auto serverTickRate = 0x6fc;
		constexpr auto clientTickRate = 0x700;
		constexpr auto serverTickInterval = 0x704;
		constexpr auto clientTickInterval = 0x708;
		constexpr auto lastSentTickTime = 0x70c;
		constexpr auto lastTickStopwatch = 0x710;
		constexpr auto lastSentTick = 0x718;
		constexpr auto nextVisThink = 0x720;
		constexpr auto lastTimeSeen = 0x724;
		constexpr auto debugPrevVisible = 0x728;
		constexpr auto fallDamageEffect = 0x730;
		constexpr auto drownEffect = 0x738;
		constexpr auto playerFlags = 0x7C8;
		constexpr auto eyes = 0x7D0;
		constexpr auto inventory = 0x7D8;
		constexpr auto blueprints = 0x758;
		constexpr auto metabolism = 0x760;
		constexpr auto modifiers = 0x768;
		constexpr auto playerCollider = 0x770;
		constexpr auto Belt = 0x780;
		constexpr auto playerRigidbody = 0x780;
		constexpr auto userID = 0x788;
		constexpr auto UserIDString = 0x790;
		constexpr auto gamemodeteam = 0x798;
		constexpr auto reputation = 0x79c;
		constexpr auto _displayName = 0x7A8;
		constexpr auto _lastSetName = 0x7a8;
		constexpr auto playerColliderStanding = 0x7b0;
		constexpr auto playerColliderDucked = 0x7c4;
		constexpr auto playerColliderCrawling = 0x7d8;
		constexpr auto playerColliderLyingDown = 0x7ec;
		constexpr auto cachedProtection = 0x800;
		constexpr auto oldCameraFix = 0x168;
		constexpr auto lastHeadshotSoundTime = 0x808;
		constexpr auto nextColliderRefreshTime = 0x80c;
		constexpr auto clothingBlocksAiming = 0x810;
		constexpr auto clothingMoveSpeedReduction = 0x814;
		constexpr auto clothingWaterSpeedBonus = 0x818;
		constexpr auto clothingAccuracyBonus = 0x81c;
		constexpr auto equippingBlocked = 0x820;
		constexpr auto eggVision = 0x824;
		constexpr auto activeTelephone = 0x828;
		constexpr auto designingAIEntity = 0x830;
	};
	...
	namespace BaseMountable {
		...
		constexpr auto canWieldItems = 0x2F0;
